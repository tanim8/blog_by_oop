...
(function(f) {
    ...
    function a(k) {
        ...
        var j = null;
        if (this.renderer.constructor != f.jqplot.PieRenderer && k.trendline.show && i) {
            j = {label: i, color: k.trendline.color}
        }
        return j
    }
    function e(m, k, j, i, l) {
        if (this.renderer.constructor == f.jqplot.LineRenderer) {
    ...
    function g(m, i) {
        ...
        if (i.show && this.renderer.constructor != f.jqplot.PieRenderer) {
            var k;
