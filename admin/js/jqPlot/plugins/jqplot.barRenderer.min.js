...
(function(d) {
    ...
    d.jqplot.BarRenderer.prototype.init = function(n, p) {
        ...
        this._dataColors = [];
        this._barPoints = [];
        var o = {lineJoin: "miter", lineCap: "round", fill: true, isarc: false, strokeStyle: this.color, fillStyle: this.color, closePath: this.fill};
        this.renderer.shapeRenderer.init(o);
        var m = {lineJoin: "miter", lineCap: "round", fill: true, isarc: false, angle: this.shadowAngle, offset: this.shadowOffset, alpha: this.shadowAlpha, depth: this.shadowDepth, closePath: this.fill};
    ...
    function h(p, o, m) {
        ...
        this.target.bind("mouseout", {plot: this}, function(q) {
            j(q.data.plot)
        })
    }
    function i() {
    ...
    function c(t, r, p, o) {
        ...
        var q = {fillStyle: n.highlightColors[p]};
