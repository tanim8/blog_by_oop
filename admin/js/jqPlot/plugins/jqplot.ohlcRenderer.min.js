...
(function(a) {
    ...
    a.jqplot.OHLCRenderer.prototype.draw = function(A, N, j) {
        ...
        if (this.show) {
            ...
            var L = K - l;
            try {
                var P = Math.abs(this._xaxis.series_u2p(parseInt(this._xaxis._intervalStats[0].sortedIntervals[0].interval)) - this._xaxis.series_u2p(0))
            } catch (H) {
                var P = I / L
            }
            if (u.candleStick) {
                if (typeof (u.bodyWidth) == "number") {
                    ...
                    u._bodyWidth = Math.min(20, P / 1.75)
                }
            } else {
