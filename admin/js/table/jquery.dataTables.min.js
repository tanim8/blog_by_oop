...
(function(i, za, p) {
    ...
    n.oPagination = {two_button: {fnInit: function(g, l, s) {
                ...
                if (g.aanFeatures.p) {
                    ...
                    for (s = t; s <= x; s++)
                        F += y != s ? '<span class="' + v.sPageButton + '">' + s + "</span>" : '<span class="' + v.sPageButtonActive + '">' + s + "</span>";
                    x = g.aanFeatures.p;
                    var z, $ = function(M) {
    ...
    i.fn.dataTable = function(g) {
        ...
        function F(a,
            ...
            if (typeof a.aoPreSearchCols[c] ==
                    "undefined" || a.aoPreSearchCols[c] === null)
        ...
        function Ma(a) {
            ...
            if (a.oScroll.sX === "") {
                ...
                if (B && (d.scrollHeight > d.offsetHeight || i(d).css("overflow-y") == "scroll"))
            ...
            if (i(a.nTable).outerWidth() < f) {
                ...
                if (a.oScroll.sX === "")
                    J(a, 1, "The table cannot fit into the current element which will cause column misalignment. The table has been drawn at its minimum possible width.");
                else
                    a.oScroll.sXInner !== "" && J(a, 1, "The table cannot fit into the current element which will cause column misalignment. Increase the sScrollXInner value or remove it to allow automatic calculation")
            } else {
                d.style.width =
                        q("100%");
        ...
        function Ha(a) {
            ...
            b.bind("keyup.DT", function() {
                for (var d = a.aanFeatures.f, f = 0, e = d.length; f < e; f++)
                    d[f] != i(this).parents("div.dataTables_filter")[0] && i("input", d[f]).val(this.value);
        ...
        function N(a, b, c) {
            ...
            for (b = 0; b < a.aoPreSearchCols.length; b++)
                Pa(a, a.aoPreSearchCols[b].sSearch, b, a.aoPreSearchCols[b].bRegex, a.aoPreSearchCols[b].bSmart);
        ...
        function Wa(a, b, c, d, f) {
            ...
            if ((wa(a) !== null ? p.cookie.length : b.length + p.cookie.length) + 10 > 4096) {
                ...
                if (f !== "")
                    p.cookie = f + "=; expires=Thu, 01-Jan-1970 00:00:01 GMT; path=" +
                            c.join("/") + "/"
            }
            p.cookie = b
        }
        ...
        this.fnDestroy = function() {
            ...
            if (a.bJUI) {
                ...
                i("th", a.nTHead).removeClass([n.oStdClasses.sSortable, n.oStdClasses.sSortableAsc, n.oStdClasses.sSortableDesc, n.oStdClasses.sSortableNone].join(" "));
            ...
            if (this.nodeName.toLowerCase() != "table")
                ...
                if (typeof g !=
                    ...
                    if (e.oFeatures.bServerSide && e.oFeatures.bSort && e.oFeatures.bSortClasses)
                        e.aoDrawCallback.push({fn: V, sName: "server_side_sort_classes"});
                    else
                        e.oFeatures.bDeferRender && e.aoDrawCallback.push({fn: V, sName: "defer_sort_classes"});
                ...
                if (typeof g.aoColumnDefs != "undefined")
                    for (a = g.aoColumnDefs.length - 1; a >= 0; a--) {
                        ...
                        for (d = m.length; c < d; c++)
                            ...
                            } else if (typeof m[c] == "number" && m[c] < 0)
